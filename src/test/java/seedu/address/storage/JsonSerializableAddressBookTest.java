...
public class JsonSerializableAddressBookTest {
    ...
    private static final Path INVALID_APPOINTMENT_BEFORE_PATIENT_DOB_FILE = TEST_DATA_FOLDER
            .resolve("invalidAppointmentBeforePatientDobAddressBook.json");
    ...
    @Test
    public void toModelType_invalidAppointmentNricNotFoundFile_throwsIllegalValueException() throws Exception {
        JsonSerializableAddressBook dataFromFile = JsonUtil.readJsonFile(INVALID_APPOINTMENT_NRIC_NOT_FOUND_FILE,
                JsonSerializableAddressBook.class).get();
        assertThrows(IllegalValueException.class, dataFromFile::toModelType);
    }

    @Test
    public void toModelType_invalidAppointmentBeforePatientDobFile_throwsIllegalValueException() throws Exception {
        JsonSerializableAddressBook dataFromFile = JsonUtil.readJsonFile(INVALID_APPOINTMENT_BEFORE_PATIENT_DOB_FILE,
                JsonSerializableAddressBook.class).get();
        assertThrows(IllegalValueException.class, dataFromFile::toModelType);
    }
}
